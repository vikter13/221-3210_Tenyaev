...
void ecall_auto_demo()
{
    ...
    printf("[auto] Type of a is int.\n");

    const auto b = local_var; // auto can be used with modifiers like const or &. 
    printf("[auto] Type of b is const double.\n");
    (void)b;

    auto c = 0, *d = &a; // multiple variable initialization if the deduced type does match 
    printf("[auto] Type of c is int.\n");
    printf("[auto] Type of d is int*.\n");
    (void)c;
    (void)d;
    ...
    printf("[auto] Type of func is void(__cdecl*)(void) \n");
    func();
...
void ecall_decltype_demo()
{
    ...
    printf("[decltype] Type of b is int.\n");
    ...
    printf("[decltype] Type of sum is double.\n");
    (void)sum;
    (void)b;
    printf("\n"); // end of demo
}
