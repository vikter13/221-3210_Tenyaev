...
_LIBCPP_ALWAYS_INLINE int sgx__builtin_popcount(unsigned int x)
{
  // Binary: 0101...
...
_LIBCPP_ALWAYS_INLINE int sgx__builtin_popcountl(unsigned long x)
{
  return sgx__builtin_popcount(static_cast<int>(x));
}

_LIBCPP_ALWAYS_INLINE int sgx__builtin_popcountll(unsigned long long x)
{
  // Binary: 0101...
