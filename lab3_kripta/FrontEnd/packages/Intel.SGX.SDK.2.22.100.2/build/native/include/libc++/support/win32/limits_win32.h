...
// The following value was checked
...
#define __builtin_nanf(__dummy)  NAN
#define __builtin_nanl(__dummmy) NAN
#define __builtin_nans(__dummy)  NAN
#define __builtin_nansf(__dummy) NAN
#define __builtin_nansl(__dummy) NAN
